...
// this Function Will Help you Create Dynamic Table irrespective of ht eNumber og Elements 
    ...
    array.forEach((element,index) => {
        ...
        values.forEach((value,keyNumber)=>{
            ...
            if(typeof value =="string")       /**/
            {
                ...
                newRow.insertCell(keyNumber+1).innerHTML=value
            }
            else{
                let IdCell = newRow.insertCell(keyNumber+1)
                IdCell.innerHTML = value        /*`${value}`*/
        ...
        <button class="btn btn-danger delete"><i class="fa-solid fa-trash-can"></i></button>`;
    });
