...
// Data will store desired data which is needed for one page
let data = Implementation.pagination( Implementation.collection,pageState?.page,pageState?.rows);
...
// in the Both Function they are Just wrapUP EventListenerUI 
